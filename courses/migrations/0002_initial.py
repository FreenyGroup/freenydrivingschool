...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='course',
            name='languages',
            field=models.ManyToManyField(related_name='courses', to='courses.language'),
        ),
        migrations.AddField(
            model_name='course',
            name='owner',
        ...
        migrations.AddField(
            model_name='course',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='courses.status'),
        ),
        migrations.AddField(
            model_name='course',
            name='students',
